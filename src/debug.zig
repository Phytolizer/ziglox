...
pub fn disassembleInstruction(c: *const Chunk, offset: usize, writer: anytype) !usize {
    ...
    switch (@intToEnum(chunk.OpCode, instruction)) {
        ...
        .equal => return try simpleInstruction("OP_EQUAL", offset, writer),
        .greater => return try simpleInstruction("OP_GREATER", offset, writer),
        .less => return try simpleInstruction("OP_LESS", offset, writer),
